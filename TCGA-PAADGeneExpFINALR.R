...
query_expPAAD <- GDCquery(project = 'TCGA-PAAD',
                          data.category = 'Transcriptome Profiling')
output_queryPAAD <- getResults(query_expPAAD)

#Retrieve Gene Expression Data Query
query_expPAADGE <- GDCquery(project = 'TCGA-PAAD',
                            data.category = 'Transcriptome Profiling',
                            experimental.strategy = 'RNA-Seq',
                            workflow.type = 'STAR - Counts',
                            access = 'open',
                            barcode = c("TCGA-FB-AAPP-01A-12R-A41B-07",
...
getResults(query_expPAADGE)

#download data
GDCdownload(query_expPAADGE)

#gene prep
gene.expPAAD <- GDCprepare(query_expPAADGE, summarizedExperiment = TRUE)
assay(gene.expPAAD)

#Retrieval
write.csv(assay(gene.expPAAD), file = "TCGA-PAADGeneExpFINAL.csv")
